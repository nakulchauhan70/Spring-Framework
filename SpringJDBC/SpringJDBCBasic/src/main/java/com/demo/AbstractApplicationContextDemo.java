...
public class AbstractApplicationContextDemo {
    ...
    public static void main(String[] args) {
        AbstractApplicationContext appContext = new FileSystemXmlApplicationContext("/SpringJDBCBasic/src/main/resources/Bean.xml");
    ...
    private static void createEmployee(EmployeeService employeeService) {
        ...
        employee.setEmail("ajay20@gmail.com");
